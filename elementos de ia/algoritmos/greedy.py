...
def greedy(initial_board, level, max_iterations=10000):
    """
    Versão do Greedy que usa apenas a contagem de bolas agrupadas como heurística.
    ...
    while heap and iterations < max_iterations:
        neg_heuristic, current_board, path = heapq.heappop(heap)
        current_heuristic = -neg_heuristic
        iterations += 1
